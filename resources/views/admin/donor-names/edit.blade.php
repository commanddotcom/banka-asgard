...
@section('title', "Редагувати ім'я")

@section('content')
    <h1 class="text-xl font-semibold mb-6">Редагувати «{{ $donorName->name }}»</h1>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm max-w-md">
        ...
        <form method="post" action="{{ route('admin.names.update', $donorName) }}" class="space-y-4">
